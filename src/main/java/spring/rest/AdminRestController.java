...
public class AdminRestController {
	...
	public ResponseEntity<UrlMessage> addCustomer(@RequestBody Customer customer) {
		...
		return new ResponseEntity<UrlMessage>(new UrlMessage("customer "+customer.getCustName()+" saved"),HttpStatus.OK);
	}
	...
	public ResponseEntity<?> getCompanyById(@RequestBody String s) {
		...
		try {
			...
			ResponseEntity<UrlMessage> r =  new ResponseEntity<UrlMessage>(new UrlMessage(e.getMessage()),HttpStatus.NOT_ACCEPTABLE);
...
public Company getCompany(@PathVariable("id")long id){
	...
	public ResponseEntity<UrlMessage> customerUpdate(@RequestBody Customer customer){
		...
		return new ResponseEntity<UrlMessage>(new UrlMessage("the customer id "+customer.getId()+" update"),HttpStatus.OK);
	}
	...
	private ResponseEntity<UrlMessage> deleteCompany(@RequestBody Company company){
	 long id = company.getId();
		...
		return new ResponseEntity<UrlMessage>(new UrlMessage("the company id "+id+" Deleted forever"),HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	private ResponseEntity<UrlMessage> deleteCustomer(@RequestBody Customer customer){
	 long id = customer.getId();
		...
		return new ResponseEntity<UrlMessage>(new UrlMessage("the customer id "+id+" Deleted forever"),HttpStatus.OK);
	}
